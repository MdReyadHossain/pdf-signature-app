import { INPUT_TYPE, inputKeyType } from "./constant";
    ...
    const htmlString = `
        <div 
            ...
            style="
                ...
                user-select: none;
            ">
                ${field?.fieldName ?? 'Field'}<span class="star-${field?.id}" style="color: red; display: none;">*</span>
...
export const generateAdminCheckField = (field: IFieldData) => {
    const htmlString = `
        <div 
            id="${field?.id ?? ''}" 
            class="field-box"
    ...
    const htmlString = `
        <div 
            ...
            style="
                ...
                user-select: none;
            ">
            <input type="${INPUT_TYPE[field?.fieldType as inputKeyType] ?? 'text'}" class="text" id="text-${field?.id}" placeholder="${field?.fieldType === 'TEXT' ? 'Text Field' : 'Number Field'}" autocomplete="off">
            ${field?.required ? '<span style="color: red;">*</span>' : ''}
        </div>
    `;
    return htmlString;
